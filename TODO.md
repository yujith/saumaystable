...
- [x] Menu page performance fixes:
  - [x] Parallelized Supabase queries (was sequential)
  - [x] Added priority image loading for first 3 meals
  - [x] Optimized Zustand selectors to prevent unnecessary re-renders
